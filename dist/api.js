...
exports.MembersApi = exports.MembersApiFactory = exports.MembersApiFp = exports.MembersApiAxiosParamCreator = exports.ErrorsApi = exports.ErrorsApiFactory = exports.ErrorsApiFp = exports.ErrorsApiAxiosParamCreator = exports.BasicApi = exports.BasicApiFactory = exports.BasicApiFp = exports.BasicApiAxiosParamCreator = exports.MemberExtendedTypeMembershipTypeEnum = exports.MemberAllAttributesMembershipTypeEnum = void 0;
...
exports.MemberAllAttributesMembershipTypeEnum = {
    Ordinary: 'ordinary',
    External: 'external',
    Graduate: 'graduate',
    Honorary: 'honorary'
    ...
    return {
        ...
        healthGet(options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['BasicApi.healthGet']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
...
class BasicApi extends base_1.BaseAPI {
     ...
     */
    healthGet(options) {
        return (0, exports.BasicApiFp)(this.configuration).healthGet(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint will return the health status of the API
     * @summary Health endpoint
...
const ErrorsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        example404Get: (options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        example500Get: (options = {}) => __awaiter(this, void 0, void 0, function* () {
...
const ErrorsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        example404Get(options) {
            var _a, _b, _c;
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.example404Get(options);
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ErrorsApi.example404Get']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        example500Get(options) {
            var _a, _b, _c;
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.example500Get(options);
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['ErrorsApi.example500Get']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
...
class ErrorsApi extends base_1.BaseAPI {
     ...
     */
    example404Get(options) {
        return (0, exports.ErrorsApiFp)(this.configuration).example404Get(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This 500 will be returned if there is a mistake in the requested path
     * @summary Example 500
     ...
     */
    example500Get(options) {
        return (0, exports.ErrorsApiFp)(this.configuration).example500Get(options).then((request) => request(this.axios, this.basePath));
    }
}
