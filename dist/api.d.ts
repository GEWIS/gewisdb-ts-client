...
export declare const MemberAllAttributesMembershipTypeEnum: {
...
export declare const BasicApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    healthGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Health>>;
    /**
     * This endpoint will return the health status of the API
     * @summary Health endpoint
     * @param {*} [options] Override http request option.
...
export declare class BasicApi extends BaseAPI {
     ...
     * @memberof BasicApi
     */
    healthGet(options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<Health, any>>;
    /**
     * This endpoint will return the health status of the API
     * @summary Health endpoint
     * @param {*} [options] Override http request option.
