...
export interface Health {
    ...
    'healthy'?: boolean;
    /**
     * Attribute to indicate that data is currently being modified and that client applications that perform syncs in the background are requested to temporarily suspend this sync.
     * @type {boolean}
     * @memberof Health
     */
    'sync_paused'?: boolean;
 ...
 * @export
 */
export type Member = MemberAllAttributes | MemberExtendedBirthDate | MemberExtendedEmail | MemberExtendedKeyholder | MemberExtendedOrgan | MemberExtendedType | MemberSimple;

/**
 * 
 * @export
 * @interface MemberAllAttributes
 */
export interface MemberAllAttributes {
    /**
     * 
     * @type {number}
     ...
     * @memberof MemberAllAttributes
     */
    'membership_type'?: MemberAllAttributesMembershipTypeEnum;
    /**
     * Date in the Y-m-d\\TH:i:sP format
     * @type {string}
     * @memberof MemberAllAttributes
...
export const MemberAllAttributesMembershipTypeEnum = {
    Ordinary: 'ordinary',
    External: 'external',
    Graduate: 'graduate',
    Honorary: 'honorary'
...
export type MemberAllAttributesMembershipTypeEnum = typeof MemberAllAttributesMembershipTypeEnum[keyof typeof MemberAllAttributesMembershipTypeEnum];
...
export const BasicApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * This endpoint will return the health status of the API and whether client applications are requested to temporarily pause their synchronisation.
...
export const BasicApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async healthGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Health>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['BasicApi.healthGet']?.[localVarOperationServerIndex]?.url;
...
export class BasicApi extends BaseAPI {
    ...
    public healthGet(options?: RawAxiosRequestConfig) {
        return BasicApiFp(this.configuration).healthGet(options).then((request) => request(this.axios, this.basePath));
    }
...
export const ErrorsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        example404Get: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/example404`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        example500Get: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/example500`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const ErrorsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async example404Get(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.example404Get(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ErrorsApi.example404Get']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * This 500 will be returned if there is a mistake in the requested path
         ...
         * @throws {RequiredError}
         */
        async example500Get(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.example500Get(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ErrorsApi.example500Get']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ErrorsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        example404Get(options?: any): AxiosPromise<void> {
            return localVarFp.example404Get(options).then((request) => request(axios, basePath));
        },
        /**
         * This 500 will be returned if there is a mistake in the requested path
         * @summary Example 500
        ...
        example500Get(options?: any): AxiosPromise<void> {
            return localVarFp.example500Get(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ErrorsApi extends BaseAPI {
     ...
     * @memberof ErrorsApi
     */
    public example404Get(options?: RawAxiosRequestConfig) {
        return ErrorsApiFp(this.configuration).example404Get(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ErrorsApi
     */
    public example500Get(options?: RawAxiosRequestConfig) {
        return ErrorsApiFp(this.configuration).example500Get(options).then((request) => request(this.axios, this.basePath));
    }
}
